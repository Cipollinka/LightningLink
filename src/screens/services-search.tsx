...
export const ServicesSearch = () => {
  ...
  const result = useMemo(() => {
    ...
    return services.filter(
      service => service.title.toLowerCase().includes(searchText.toLowerCase()) ||
        service.comment.toLowerCase().includes(searchText.toLowerCase()),
    );
  }, [searchText, userProfile?.services]);

...
import {EntertainmentTab} from './entertainment-tab.tsx';

export const EntertainmentScreen = () => {
  ...
  const result = services.filter(
    service => service.category === ServiceCategory.Entertainment,
  );
    ...
    <View
      ...
      <View
        ...
        <View
          ...
          <EntertainmentTab isEmpty={isEmpty} result={result} />

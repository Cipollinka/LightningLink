...
export const ServicesTab: FC<Props> = ({ isEmpty }) => {
      ...
      <View>
        ...
        <FlatList
          ...
          data={[
            {
              onClick: () => {
                navigate(ScreenNames.Study);
              },
              image: require("../../shared/assets/bookcategory.png")
            },
            {
              onClick: () => {
                navigate(ScreenNames.Work);
              },
              image: require("../../shared/assets/pccategory.png")
            },
            {
              onClick: () => {
                navigate(ScreenNames.Entertainment);
              },
              image: require("../../shared/assets/gamecategory.png")
            },
            {
              onClick: () => {
                navigate(ScreenNames.Life);
              },
              image: require("../../shared/assets/coffecategory.png")
            }
          ]}
          numColumns={2}
